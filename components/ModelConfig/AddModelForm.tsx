...
/** 获取所有提供商 */
const getAllowedProviders = () => getProviders();
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <select
            ...
            className="w-full bg-white/[0.06] border border-white/10 rounded-xl px-3 py-2 text-xs text-white focus:outline-none focus:border-cyan-500/50"
          >
